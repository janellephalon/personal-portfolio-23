...
## User Story
```
AS AN employer seeking a full-stack developer,
I WANT to view a developers deployed portfolio,
SO THAT I can evaluate and assess their skills as a web developer. 
```
